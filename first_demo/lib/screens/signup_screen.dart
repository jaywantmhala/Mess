...
// ── Design tokens ──────────────────────────────────────────────────────────────
const _kCoralPrimary = Color(0xFFE8614A);
...
class _SignUpScreenState extends State<SignUpScreen>
  ...
  Future<void> _onSignUp() async {
    ...
    if (result.success) {
      _showSnack('Account created! Welcome, ${result.customer?.fullName ?? ''}! 🎉', isError: false);
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Row(
                                ...
                                children: [
                                  const Icon(Icons.arrow_back_ios_rounded, size: 14, color: _kTextMuted),
                                  const SizedBox(width: 4),
                                  Text('Back to Login', style: TextStyle(fontSize: 13, color: Colors.grey[500])),
                                ],
                              ),
                            ),
                            ...
                            const Text('Sign Up', style: TextStyle(
                              ...
                              color: _kTextDark, letterSpacing: -0.5,
                            )),
                                ...
                                children: [
                                  AnimatedContainer(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: _agreeTerms ? _kCoralPrimary : Colors.white,
                                      border: Border.all(
                                        color: _agreeTerms ? _kCoralPrimary : _kBorderColor,
                                        width: 1.8,
                                      ),
                                    ),
                                    child: _agreeTerms
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: _kCoralPrimary,
                                  foregroundColor: Colors.white,
                                  disabledBackgroundColor: _kCoralPrimary.withValues(alpha: 0.6),
                                  elevation: 4,
                                  shadowColor: _kCoralPrimary.withValues(alpha: 0.35),
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    ...
                                    children: const [TextSpan(
                                      text: 'Sign in',
                                      style: TextStyle(color: _kCoralPrimary, fontWeight: FontWeight.w700),
                                    )],
                                  ),
                                ),
                              ),
...
class _FieldLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Text(text, style: const TextStyle(
    fontSize: 13.5, fontWeight: FontWeight.w600, color: _kTextDark,
  ));
}
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: const BorderSide(color: _kBorderColor, width: 1.4),
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(color: _kCoralPrimary, width: 1.8),
        ),
